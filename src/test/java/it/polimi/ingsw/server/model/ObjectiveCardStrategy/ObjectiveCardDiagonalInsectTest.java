...
class ObjectiveCardDiagonalInsectTest {
    ...
    void calculatePointsSimpleCase() {
        ...
        try {
            ...
            player.place(new ResourceCard(38), true, -1,1);
            player.place(new ResourceCard(38), true, -2,2);
            player.place(new ResourceCard(38), true, -3,3);
    ...
    void calculatePointsDiagonalWith4CardsCase() {
        ...
        try {
            ...
            player.place(new ResourceCard(38), true, -2,2);
            player.place(new ResourceCard(38), true, -3,3);
            player.place(new ResourceCard(38), true, -4,4);
        } catch (CannotPlaceCardException e) {
            throw new RuntimeException(e);
        }
        assertEquals(2,objectiveCard.getEarnedPoints(player.getGamefield()));
    ...
    void calculatePointsDoubleTripletCase() {
        ...
        try {
            ...
            player.place(new ResourceCard(38), true, -2,2);
            player.place(new ResourceCard(38), true, -3,3);
            player.place(new ResourceCard(38), true, -2,4);
            player.place(new ResourceCard(38), true, -3,5);
            player.place(new ResourceCard(38), true, -4,6);
        } catch (CannotPlaceCardException e) {
            throw new RuntimeException(e);
        }
