...
class ObjectiveCardDiagonalPlantTest {
    ...
    void calculatePointsSimpleCase() {
        ...
        try {
            ...
            gameField.place(new ResourceCard(18),-1,1);
            gameField.place(new ResourceCard(18),-2,2);
            gameField.place(new ResourceCard(18),-3,3);
    ...
    void calculatePointsDiagonalWith4CardsCase() {
        ...
        try {
            ...
            gameField.place(new ResourceCard(18),-2,2);
            gameField.place(new ResourceCard(18),-3,3);
            gameField.place(new ResourceCard(18),-4,4);
        } catch (CannotPlaceCardException e) {
            throw new RuntimeException(e);
        }
        assertEquals(2,objectiveCard.getEarnedPoints(gameField));
    ...
    void calculatePointsDoubleTripletCase() {
        ...
        try {
            ...
            gameField.place(new ResourceCard(18),-3,5);
            gameField.place(new ResourceCard(18),-4,6);
        } catch (CannotPlaceCardException e) {
            throw new RuntimeException(e);
        }
