...
/**
 * This class is used to implement the Animal-Animal-Fungi pattern strategy
 */
public class ObjectiveCardJPatternAAF implements ObjectiveStrategy {
    ...
    public int calculatePoints(int pointsOnTheCard, GameField gamefield) {
        ...
        for (PlaceableCard c : gamefield.getFungiCards())
        {
            ...
            if(card_tempA!=null && card_tempA.getCardKingdom() == Resource.animal && !visitedCards.contains(card_tempA))
            {
                if(card_tempB!=null && card_tempB.getCardKingdom() == Resource.animal && !visitedCards.contains(card_tempB)) {
