...
public class ObjectiveCardJPatternFFP implements ObjectiveStrategy{
    public int calculatePoints(int pointsOnTheCard, GameField gamefield) {
        ...
        for (PlaceableCard c : gamefield.getPlantCards())
        {
            ...
            if(card_tempA!=null && card_tempA.getCardKingdom() == Resource.fungi && !visitedCard.contains(card_tempA))
            {
                if(card_tempB!=null && card_tempB.getCardKingdom() == Resource.fungi && !visitedCard.contains(card_tempB)) {
